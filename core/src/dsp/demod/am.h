...
namespace dsp::demod {
    ...
    public:
        ...
        void init(stream<complex_t>* in, AGCMode agcMode, double bandwidth, double agcAttack, double agcDecay, double dcBlockRate, double samplerate) {
            ...
            carrierAgc.init(NULL, 1.0, agcAttack, agcDecay, 10e6, loop::AUDIO_AGC_CEILING, INFINITY);
            audioAgc.init(NULL, 1.0, agcAttack, agcDecay, 10e6, loop::AUDIO_AGC_CEILING, INFINITY);
